...
export async function getDynamicSitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    page("/tournament-simulation", "weekly", 0.66),
    page("/fan-polls", "daily", 0.64),
    page("/prediction-leaderboard", "daily", 0.64),
    page("/guides", "monthly", 0.72),
    page("/injuries", "hourly", 0.58),
    page("/suspensions", "hourly", 0.58),
