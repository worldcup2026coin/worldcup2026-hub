  ...
  return (
    <section className="rounded-3xl border border-white/10 bg-white/[0.055] p-6 shadow-2xl shadow-slate-950/30">
      ...
      <p className="mt-3 text-sm leading-6 text-slate-300">
        This is a general match-centre context area. Later, an admin/content system can add storylines, team news, tactical notes and form context without changing the match page structure.
      </p>
    </section>
  );
}
